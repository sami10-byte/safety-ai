...
.hero{min-height:100vh;padding:40px;display:flex;align-items:center;justify-content:center;background:#f4f7f6}
.wrap{max-width:1200px;width:100%;text-align:center}
.logo{font-size:80px}
h1{font-size:52px;color:#064e3b;margin:15px 0}
.desc{font-size:23px;line-height:2;color:#333}
.cards{display:grid;grid-template-columns:repeat(auto-fit,minmax(320px,1fr));gap:30px;margin-top:50px}
.card{background:white;padding:35px;border-radius:25px;box-shadow:0 10px 30px rgba(0,0,0,.12)}
.card-icon{font-size:70px}
.card h2{font-size:34px;color:#065f46;margin:15px 0}
.card p{font-size:20px;line-height:1.8;color:#444}
.btn{display:inline-block;margin-top:25px;background:#065f46;color:white;text-decoration:none;padding:16px 35px;border-radius:14px;font-size:22px}
.footer{margin-top:35px;background:#065f46;color:white;padding:18px;border-radius:15px;font-size:20px}
</style>
</head>
<body>
<section class="hero">
...
<p class="desc">بيئة آمنة .. عمل مستدام</p>
<p class="desc">منصة ذكية لإدارة تقارير الصحة والسلامة المهنية</p>
...
<a href="/ask" class="btn">اسأل الآن</a>
</div>
</div>
...
button,a{background:#065f46;color:white;padding:14px 22px;border-radius:12px;border:none;text-decoration:none;font-size:18px;display:inline-block;margin-top:15px}
.answer{background:#ecfdf5;margin-top:20px;padding:20px;border-radius:15px;line-height:2;display:none;font-size:18px}
</style>
</head>
<body>
<div class="card">
...
.form{background:white;max-width:1100px;margin:auto;padding:25px;border-radius:20px;box-shadow:0 8px 25px rgba(0,0,0,.1)}
h1{color:#064e3b;margin-bottom:20px}
...
.report{max-width:1000px;margin:30px auto;background:white;display:none;border-radius:10px;overflow:hidden;border:1px solid #ccc}
.report-header{padding:18px;text-align:center;border-bottom:2px solid #ccc}
.report-header h1{font-size:34px;color:#064e3b}

.info{display:grid;grid-template-columns:repeat(3,1fr);border-bottom:1px solid #ccc}
.info div{padding:14px;text-align:center;border-left:1px solid #ccc;font-size:16px}

.section{padding:10px 18px}
.section-title{background:#065f46;color:white;padding:9px;font-size:18px;border-radius:8px 8px 0 0}
.box{border:1px solid #aaa;padding:10px;line-height:1.5;font-size:14px;border-radius:0 0 8px 8px}
.image-box{border:1px solid #aaa;padding:10px;text-align:center;border-radius:0 0 8px 8px}
.image-box img{width:70%;max-height:170px;object-fit:cover;border-radius:8px}
ul{padding-right:22px;line-height:1.5;font-size:14px}

.footer{background:#065f46;color:white;padding:10px;display:grid;grid-template-columns:repeat(3,1fr);text-align:center;margin-top:12px;font-size:13px}
...
@media print{
  ...
  .report-header{padding:6px}
  .report-header h1{font-size:23px}
  .report-header div{font-size:38px!important}
...
<div class="footer">
<div>📅 التاريخ: <span id="rDate"></span></div>
